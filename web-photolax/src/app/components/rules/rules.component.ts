        ...
        <div class="rules-container">
            ...
            <div class="content-wrapper">
                <div class="rules-content">
                    <h1 class="rulesTitle reveal-text">RULES</h1>
                    <div class="line"></div>
                    
                    <h2 class="rally-title reveal-text">Sunsets & Rises Rally</h2>
                    
                    <div class="rule-section slide-in">
                        <h3>General Rules</h3>
                        <ul>
                            <li>All photographs must be taken during sunrise or sunset hours</li>
                            <li>Photos must be taken during the rally period</li>
                            <li>No heavy post-processing or composites allowed</li>
                            <li>Basic adjustments (exposure, contrast, white balance) are permitted</li>
                            <li>Original RAW files may be requested for verification</li>
                        </ul>
                    </div>
                    ...
                    <div class="rule-section slide-in">
                        ...
                        <ul>
                            <li>Minimum resolution: 3000x2000 pixels</li>
                            <li>Format: JPG or RAW</li>
                            <li>Maximum file size: 20MB per photo</li>
                            <li>Must include EXIF data</li>
                        </ul>
                    </div>
                    ...
                    <div class="rule-section slide-in">
                        ...
                        <ul>
                            <li>Each participant can submit up to 3 photos</li>
                            <li>Photos must be submitted through your account dashboard</li>
                            <li>Include location and time of capture</li>
                            <li>Brief description of the photo (optional)</li>
                            <li>Deadline: Check rally details for specific dates</li>
                        </ul>
                    </div>
                    ...
                    <div class="rule-section slide-in">
                        ...
                        <ul>
                            <li><span class="percentage">30%</span> Composition and framing</li>
                            <li><span class="percentage">30%</span> Light quality and exposure</li>
                            <li><span class="percentage">20%</span> Creativity and originality</li>
                            <li><span class="percentage">20%</span> Technical execution</li>
                        </ul>
                    </div>
                </div>
            </div>
